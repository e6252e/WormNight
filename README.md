...
[![PDF](https://img.shields.io/badge/기술_포트폴리오(PDF)-28A745?style=for-the-badge&logo=adobeacrobatreader&logoColor=white)](https://drive.google.com/file/d/1qNXeqf5UI0nfVkJ6S7QI3OMacZTonnjd/view?usp=sharing)
[![PPT](https://img.shields.io/badge/기술_포트폴리오(PPT)-FFC107?style=for-the-badge&logo=microsoftpowerpoint&logoColor=black)](https://drive.google.com/file/d/13rZPJvDjHYrOJERBvmtEnuEQtMVffXs-/view?usp=sharing)
...
| **개발 방식** | 팀 프로젝트 |
| **담당 업무** | UI 시스템 · 성장 시스템 · 데이터 저장 · 기능 구현 |

---

## 🎮 게임 소개

플레이어는 기사 형태의 웜 캐릭터를 조작해 중앙의 **넥서스(Nexus)**를 방어합니다.  
전투에서 경험치를 획득하고 레벨업할 때마다 **3장의 카드 중 하나를 선택**해 새로운 무기를 장착하거나 기존 능력을 강화합니다.

플레이 종료 후에도 획득한 재화와 성장 정보는 유지됩니다.  
반복 플레이를 통해 캐릭터를 영구 강화하고 새로운 캐릭터를 해금하며 더 높은 웨이브에 도전할 수 있습니다.
